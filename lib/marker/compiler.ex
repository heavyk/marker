defmodule Marker.Compiler do
  ...
  defp compile(%Element{tag: :_fragment, content: content}, chunks) do
    Enum.reduce(content, chunks, &compile/2)
  end
  defp compile(%Element{tag: :_template, content: content}, chunks) do
    compile(content, chunks)
  end
  defp compile(%Element{tag: :_component, content: content}, chunks) do
    compile(content, chunks)
  end
